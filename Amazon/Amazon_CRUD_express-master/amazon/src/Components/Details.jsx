            ...
            <Col className="info" xs={7}>
              ...
              <div className="stars-outer">
                ...
                <div
                  ...
                  style={{
                    width: `${
                      (this.state.product.totalRating /
                        this.state.product.NumberOfReviews) *
                      20
                    }%`,
                  }}
                >
            ...
            <Col xs={1}>
              <Dropdown>
                ...
                <Dropdown.Menu>
                  ...
                  <Dropdown.Item
                    onClick={() => this.removeProduct(this.state.product._id)}
                  >
                    Delete Product
                  </Dropdown.Item>

                  <Dropdown.Item
                    onClick={() => this.downloadProduct(this.state.product._id)}
                  >
                    Download Product
                  </Dropdown.Item>
                </Dropdown.Menu>
